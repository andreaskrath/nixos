...
#!nix-shell -i python3 -p "python3.withPackages (ps: with ps; [ pyelftools capstone ])"

# https://github.com/sersorrel/sys/blob/de1ce2ba941318a05d4d029f717ad8be7b4b09ee/hm/discord/krisp-patcher.py
import sys
import shutil
